import { Users, Wand2, Eye, Sparkles } from "lucide-react"

export function HowItWorks() {
  return (
    <section id="how-it-works" className="container py-12 lg:py-24">
      <div className="text-center space-y-4 mb-12">
        <h2 className="text-3xl md:text-4xl font-bold">Get Started in Four Simple Steps</h2>
        <p className="text-lg text-muted-foreground">From character creation to enhanced narratives and vivid descriptions.</p>
      </div>
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center relative">
        ...
        <div className="flex flex-col items-center space-y-4 z-10 bg-background p-4">
          ...
          <h3 className="text-xl font-semibold">3. Generate Descriptions</h3>
          <p className="text-muted-foreground">
            Upload images to create detailed character descriptions and scene references with our AI vision tools.
          </p>
        </div>
        <div className="flex flex-col items-center space-y-4 z-10 bg-background p-4">
          <div className="flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 border-2 border-primary text-primary">
          ...
          <h3 className="text-xl font-semibold">4. Copy & Roleplay</h3>
          <p className="text-muted-foreground">Get rich, in-character narratives and vivid descriptions ready for any roleplay platform.</p>
        </div>
      </div>
    </section>
  )
